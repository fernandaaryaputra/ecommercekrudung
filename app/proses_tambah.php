...
if($image != ""){
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
    ...
    }else {echo "<script>alert('Ekstensi gambar hanya bisa jpg dan png!');window.location='button_tambah.php';</script>";
}
}else {
        ...
        if(!$result){
            die ("Query Error : ".mysqli_error($mysqli)."-".mysqli_error($mysqli));
        }else {echo "<script> alert('Data berhasil ditambahkan!');window.location='index.php';</script>";
        }
